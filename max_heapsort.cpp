...
int main()
{
  ...
  conclusion :
  i had  done this practical it is based on the binary search ( exactly 2 nodes ) not more than that , and it helps us to sorting either ascending order or descending order
